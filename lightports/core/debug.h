...
#define win_throw_on_fail(expr) (::Windows::checkReturnValue((expr), __PRETTY_FUNCTION__, "[" __FILE__ ":" CPP_STRINGIFY(__LINE__) "]", ::Windows::throwWindowsFail))
#define win_print_on_fail(expr) (::Windows::checkReturnValue((expr), __PRETTY_FUNCTION__, "[" __FILE__ ":" CPP_STRINGIFY(__LINE__) "]", ::Windows::printWindowsFail))
